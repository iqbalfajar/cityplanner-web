...
map.on('click', function (e) {
    ...
    var popup = new mapboxgl.Popup()
        ...
        .setHTML("<a href='#/menu/zone-detail/hotel/"+feature.properties.kode15+"' ng-click='triggerClick()' class='a-iframe'>" + feature.properties.kategori + "</a>")
        .addTo(map);
});
